    ...
    <section id="footer">
      <div className="h-screen bg-[url('/images/gallery/bg.jpg')] bg-cover bg-[47.5%] bg-no-repeat flex items-end">
        <div className="relative">
          <div className="bg-[linear-gradient(180deg,#FFFFFF00_0%,#871F78_67%)] absolute inset-x-0 bottom-0 -top-24"></div>
      ...
      <div className="bg-[#871F78] p-20 flex items-center justify-center">
